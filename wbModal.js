...
define("wbModal", function(){
        function Modal(heading,foot){
               this.modal="<!-- Modal Start -->" +
                   "<div id='exceptionModal' class='modal hide fade' tabindex='-1' role='dialog' aria-labelledby='modalLabel' aria-hidden='true'>" +
                       "\n<div class='modal-header'>" +
                       "\n<button type='button' class='close' data-dismiss='modal' aria-hidden='true'>X</button>";
            if(heading)this.modal +="\n<h3 id='modalLabel'>"+heading+"</h3>";
            this.modal +="\n</div>" +
